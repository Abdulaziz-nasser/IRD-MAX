...
|---|---|---|
| NVIDIA Jetson Nano | 1 | [Jetson Nano user guide](https://developer.nvidia.com/embedded/dlc/jetson_nano_developer_kit_user_guide) |
...
| DC-DC step-down regulator | See power notes | [Supply details](power/) |
